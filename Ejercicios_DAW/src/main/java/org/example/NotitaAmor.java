    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            switch (posicionAlumno) {
                case 0:
                    movimientosValidos = "N,E";
                    break;
                case 1:
                    movimientosValidos = "N,E,O";
                    break;
                case 2:
                    movimientosValidos = "N,O";
                    break;
                case 3:
                    movimientosValidos = "S,E";
                    break;
                case 4:
                    movimientosValidos = "S,O,E";
                    break;
                case 5:
                    movimientosValidos = "S,O";
                    break;
                default:
                    movimientosValidos = "";
            }
                ...
                switch (posicionAlumno) {
                    case 0:
                        switch (direccionChar) {
                            case 'N':
                                nuevaPosicion = 3;
                                nombreDireccion = "Norte";
                                break;
                            case 'E':
                                nuevaPosicion = 1;
                                nombreDireccion = "Este";
                                break;
                        }
                        break;
                    case 1:
